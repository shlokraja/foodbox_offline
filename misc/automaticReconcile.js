                    ...
                    if (err) {
                        ...
                        for (var key in reply_po_details) {
                            if (reply_po_details.hasOwnProperty(key)) {
                                ...
                                console.log('************************************************');
                                console.log('element                              from outlet recosile', typeof element);
                                console.log('************************************************');
                                
                                if (typeof element !="undefined" && element[0].is_generated_from_scan != "undefined" && element[0].is_generated_from_scan == true) {
                        ...
                        console.log('************************************************');
                        console.log('data from automatic Reconsile js', data);
                        console.log('************************************************');
...
function save_reconcile_data_main(reconcile_items, excess_quantity_items, callback) {
    ...
    console.log("AutomaticReconcile function :: save_reconcile_data:: function started ################################################### reconcile_items:: " + reconcile_items.length);
...
function send_restatrant_excess_po_mail_main(reconcile_items, excess_quantity_items, callback) {
    console.log("******************************send_restatrant_excess_po_mail_main************************" + reconcile_items.length)
...
function update_received_time(reconcile_items, excess_quantity_items, callback) {
    ...
    console.log("******************************update_received_time************************" + reconcile_items.length)
...
function IncomingPOProcess(purchase_order_id, restaurant_id, reconcile_items) {
    console.log("******************************Reconcile************************" + reconcile_items.length)
    console.log("******************************Reconcile************************" + outlet_url + '/outlet_app/store_last_load_info')
    console.log("******************************Reconcile************************" + purchase_order_id)
    console.log("******************************Reconcile************************" + restaurant_id)
