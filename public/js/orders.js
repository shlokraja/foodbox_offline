...
$("#replace_confirm").click(function () {
	...
	$.ajax({
		...
		success: function (data) {
			console.log("function reched 378");
			console.log(data);
			// updateSalesSummary(item_details)
			var outside_items = 0;
...
function openOrderItems(outlet_order_id, order_id, mobile_num, payment_mode, scope) {
	console.log('************************************************');
	console.log('outlet_order_id' + outlet_order_id);
	console.log('************************************************');
